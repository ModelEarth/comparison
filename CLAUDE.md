...
For each country and year, there are 8 files generated by the exibase/tradeflow python to use in the dynamic comparison reports. These reside in each year folder in the [trade-data repo](https://github.com/ModelEarth/trade-data/tree/main/year) at trade-data/[year]/[country]
...
Join those to each country's six annual tradeflow file in the country folder at:
